(() => {
  ...
  // src/vendor/workspace-virtual.entry.js
  var toFiniteNumber = (value, fallback = 0) => {
    const number = Number(value);
    return Number.isFinite(number) ? number : fallback;
  };
  var calculateVirtualGridMetrics = (options = {}) => {
  ...
  var buildVirtualGridRows = (images, columns) => {
  ...
  var createElementVirtualizer = (options = {}) => {
